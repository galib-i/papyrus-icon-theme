...
A personal fork of [Papirus Icon Theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) by the [Papirus Development Team](https://github.com/PapirusDevelopmentTeam), renamed to Papyrus to avoid conflicts with the original.
